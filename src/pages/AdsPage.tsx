...
export function AdsPage() {
  ...
  // adGroupId required by loadAppsInTossAdMob / showAppsInTossAdMob (3.x cell: required `options`)
  ...
  // adGroupId required by loadFullScreenAd / showFullScreenAd (3.x cell: required `options`)
