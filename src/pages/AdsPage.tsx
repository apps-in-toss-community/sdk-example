  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-3 py-2">
          ...
          <CodeSnippet code={loadAppsInTossAdMobSnippet} />
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-3 py-2">
          ...
          <CodeSnippet code={showAppsInTossAdMobSnippet} />
        </div>
      ),
    },
  ];
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
              ...
              <CodeSnippet code={loadFullScreenAdSnippet} />
            </div>
            {/* showFullScreenAd */}
            <div className="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
              <h3 className="text-sm font-semibold text-gray-900 font-mono dark:text-gray-100">
              ...
              <CodeSnippet code={showFullScreenAdSnippet} />
            </div>
