...
- **Image build**: `pnpm build:og` or the prebuild step of `pnpm build` runs `scripts/build-og-images.tsx` to generate 17 images (`public/og/<slug>.png`) — one for home and one per group. PNG files are committed.
